...
pub const PUMP_FUN_SELL_DISCRIMINATOR: u8 = 2;
...
impl PumpFunSell {
    pub fn instruction(&self, args: PumpFunSellInstructionArgs) -> solana_instruction::Instruction {
    ...
    pub fn instruction_with_remaining_accounts(
        &self,
        args: PumpFunSellInstructionArgs,
        ...
        let mut data = PumpFunSellInstructionData::new().try_to_vec().unwrap();
...
pub struct PumpFunSellInstructionData {
    discriminator: u8,
}

impl PumpFunSellInstructionData {
    pub fn new() -> Self {
...
impl Default for PumpFunSellInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
#[derive(BorshSerialize, BorshDeserialize, Clone, Debug, Eq, PartialEq)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct PumpFunSellInstructionArgs {
    pub amount: u64,
    pub min_sol_output: u64,
}

impl PumpFunSellInstructionArgs {
    pub(crate) fn try_to_vec(&self) -> Result<Vec<u8>, std::io::Error> {
        borsh::to_vec(self)
    }
}

/// Instruction builder for `PumpFunSell`.
///
/// ### Accounts:
///
///   0. `[]` global
...
impl PumpFunSellBuilder {
    ...
    pub fn instruction(&self) -> solana_instruction::Instruction {
        ...
        let args = PumpFunSellInstructionArgs {
...
/// `pump_fun_sell` CPI accounts.
pub struct PumpFunSellCpiAccounts<'a, 'b> {
    /// Global state PDA
...
/// `pump_fun_sell` CPI instruction.
pub struct PumpFunSellCpi<'a, 'b> {
    ...
    pub __args: PumpFunSellInstructionArgs,
}

impl<'a, 'b> PumpFunSellCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_account_info::AccountInfo<'a>,
        accounts: PumpFunSellCpiAccounts<'a, 'b>,
        args: PumpFunSellInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `PumpFunSell` via CPI.
///
/// ### Accounts:
///
///   0. `[]` global
...
///   13. `[]` fee_program
#[derive(Clone, Debug)]
pub struct PumpFunSellCpiBuilder<'a, 'b> {
    instruction: Box<PumpFunSellCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> PumpFunSellCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(PumpFunSellCpiBuilderInstruction {
            __program: program,
            global: None,
            fee_recipient: None,
            mint: None,
    ...
    pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program_error::ProgramResult {
        ...
        let instruction = PumpFunSellCpi {
...
#[derive(Clone, Debug)]
struct PumpFunSellCpiBuilderInstruction<'a, 'b> {
